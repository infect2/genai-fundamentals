...
3. Run the [`genai-fundamentals/tools/verify_environment.py`](./genai-fundamentals/tools/verify_environment.py) program to check the environment is set up correctly.
