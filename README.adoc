...
* *MCP Server*: Claude Desktop 연동을 위한 Model Context Protocol 지원 (v1 단일 에이전트 + v2 멀티 에이전트)
...
| `agent_query` | v1 단일 ReAct Agent 쿼리
| `multi_agent_query` | v2 멀티 에이전트 도메인 쿼리 (WMS/TMS/FMS/TAP 자동 라우팅)
